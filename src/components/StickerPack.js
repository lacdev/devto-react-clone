...
function StickerPack() {
    return (
        <div class="m-3 place-items-center content-center bg-[#f9f9f9] text-[#3d3d3d] w-60 flex-column rounded">
            <div class="px-4 py-4 w-60 rounded">
                 <img class="rounded"
            ...
            <div class="text-left mt-3 text-[#323ebe] font-bold">
                <a href="#">Do you have your sticker pack yet?</a>
            </div>
        </div>
    )
}
