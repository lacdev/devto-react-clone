...
function OnePostRightBar() {
    const parent ='grid row-end-2 h-max w-16 block'
    ...
    const btnhearthover = 'flex mx-1 p-2 focus-visible hover:bg-red-200 hover:rounded-full hover:fill-red-700'
    const btnunicornhover = 'flex mx-1 p-2 focus-visible hover:bg-cyan-100 hover:rounded-full hover:fill-cyan-300'
    const btnsavehover = 'flex mx-1 p-2 focus-visible hover:bg-indigo-100 hover:rounded-full  hover:fill-indigo-600'
    const btnpointshover = 'flex mx-1 p-2 focus-visible hover:bg-zinc-200 hover:rounded-full hover:fill-stone-500'
                ...
                <div className= {gridcol}>
                 ...
                 <div className='relative text-center'>
                     <button className={btnicon} >
                         ...
                         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" aria-hidden="true" class="dropdown-icon crayons-icon"><title>More...</title><path fill-rule="evenodd" clip-rule="evenodd" d="M7 12a2 2 0 11-4 0 2 2 0 014 0zm7 0a2 2 0 11-4 0 2 2 0 014 0zm5 2a2 2 0 100-4 2 2 0 000 4z"></path>
                         </svg>
                         </span>
                     </button>
