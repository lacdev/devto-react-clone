    ...
    <div className={parent}>
      <span className={conicon}>
        <svg
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-labelledby="a8ls8t98cb6es3zuqibefmsgj98sg8gp"
          class="crayons-icon c-link__icon"
        >
          <title id="a8ls8t98cb6es3zuqibefmsgj98sg8gp">Twitter</title>
          <path
      ...
      <span className={conicon}>
        <svg
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-labelledby="a1bdy0g8dx9d46vwso4dzbvtnjrxl3sp"
          class="crayons-icon c-link__icon"
        >
          <title id="a1bdy0g8dx9d46vwso4dzbvtnjrxl3sp">Facebook</title>
      ...
      <span className={conicon}>
        <svg
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-labelledby="ahk0ybak6ce82giisk56tigmzeo5psq1"
          class="crayons-icon c-link__icon"
        >
          <title id="ahk0ybak6ce82giisk56tigmzeo5psq1">Github</title>
      ...
      <span className={conicon}>
        <svg
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-labelledby="aipuab84ngav1kooqtwldyuz0112peu8"
          class="crayons-icon c-link__icon"
        >
          <title id="aipuab84ngav1kooqtwldyuz0112peu8">Instagram</title>
      ...
      <span className={conicon}>
        <svg
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-labelledby="a4wvhkh3rmuvlcexbhxswjxstqlv39ih"
          class="crayons-icon c-link__icon"
        >
          <title id="a4wvhkh3rmuvlcexbhxswjxstqlv39ih">Twitch</title>
