...
function PostProfile() {
    return (
        <div class="text-[#3d3d3d] bg-[#f9f9f9] border-t-[32px] border-[#323ebe] p-4 mt-6 w-80">
            <div class="flex w-full justify-center relative">
                <img class="rounded-full w-12" src="https://res.cloudinary.com/practicaldev/image/fetch/s--Ea1OGrCb--/c_fill,f_auto,fl_progressive,h_90,q_auto,w_90/https://dev-to-uploads.s3.amazonaws.com/uploads/user/profile_image/1/f451a206-11c8-4e3d-8936-143d0a7e65bb.png"></img>
